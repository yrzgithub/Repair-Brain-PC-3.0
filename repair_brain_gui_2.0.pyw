...
def forget_password_fn():
    ...
    def run_on_thread():
        if not is_valid_entry(entry,"Enter your E-mail"):
            return msgbox(master=canvas,msg="Invalid email")
        ...
        try:
            ...
            msgbox(msg="Password Reset Link has been Sent")

        except:
            msgbox(msg="Something went wrong")
